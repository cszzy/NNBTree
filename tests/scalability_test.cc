...
//       break;
//     case 's':
//       scan_size.push_back(atoi(optarg));
//       break;
//     case 'd':
//       use_data_file = true;
//       break;
...
//   {
//   case 0:
//     key = load_data_from_osm<uint64_t>("/home/wjy/generate_random_osm_longtitudes.dat");
//     break;
//   case 1:
//     key = load_data_from_osm<uint64_t>("/home/wjy/generate_random_osm_longlat.dat");
//     break;
//   case 2:
//     key = load_data_from_osm<uint64_t>("/home/wjy/lognormal.dat");
//     break;
//   case 3:
//     key = load_data_from_osm<uint64_t>("/home/wjy/generate_random_ycsb.dat");
//     break;
//   default:
//     std::cout << "error:not select data set!" << std::endl;
//     break;
//   }
//   NVM::env_init();
//   KvDB *db = nullptr;
